...
function normalizeChoices(Model, Choices) {
...
// score choices
function scoreChoices(normchoices, Model) {
    let scores = [];
...
function chooseLinear(Model, Choices) {
    // nomalize
 ...
 */
function findLinearModelWeights(ZeroWeightModel, OrderedBestChoices, iteration) {
...
/*
 ...
 iteration: number of iteration for optimization algorithm to find the model (more iteration, better result)
 */
function findLinearModelWeightsWithLargDist(ZeroWeightModel, OrderedBestChoices, iteration) {
    console.log('here findLinearModelWeights');
    let genetic = Genetic.create();
    genetic.optimize = Genetic.Optimize.Minimize;
    genetic.select1 = Genetic.Select1.Tournament2;
